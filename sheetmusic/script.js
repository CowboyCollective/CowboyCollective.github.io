...
function getEmbed(i) {
  i = i.replace(/\/download\//g, "/embed/") + "?ui=embed#mode/2up/"
  console.log(i)
  return i
}
...
function createBook(i){
  ...
  book.onmouseover = function(){
    ...
    document.getElementById("bookTitle").innerHTML = comics[i][1]
    document.getElementById("titleII").innerHTML = comics[i][1]
    document.getElementById("bookDate").innerHTML = months[comics[i][1]] + comics[i][0]
    document.getElementById("bookNumb").innerHTML = comics[i][2]
  }
  book.onclick = function(){
    document.getElementById("footer").style.visibility = "hidden"
    document.getElementById("preview").style.visibility = "visible"
    document.getElementById("book").src = getEmbed(comics[i][2])
    document.getElementById("clicker").onclick = function(){ window.open(comics[i][2]) }
  }
  document.getElementById("body").appendChild(book)
}
